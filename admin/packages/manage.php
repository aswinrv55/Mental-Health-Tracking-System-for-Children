...
<div class="card card-outline card-info">
    <div class="card-header">
        <h3 class="card-title"><?php echo isset($id) ? "Update " : "" ?>Create New Activities</h3>
    </div>
    <div class="card-body">
        <form action="" id="package-form">
            <input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
            
            <!-- Activities Title Field -->
            <div class="form-group">
                <label for="title" class="control-label">Activities Title</label>
                <textarea name="title" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($title) ? $title : ''; ?></textarea>
            </div>
            
            <!-- Description Field -->
            <div class="form-group">
                <label for="description" class="control-label">Description</label>
                <textarea name="description" cols="30" rows="2" class="form-control form no-resize summernote"><?php echo isset($description) ? $description : ''; ?></textarea>
            </div>

            <!-- URL Field -->
            <div class="form-group">
                <label for="url" class="control-label">Page URL</label>
                <input type="text" name="url" id="url" class="form-control" value="<?php echo isset($url) ? $url : ''; ?>">
            </div>
