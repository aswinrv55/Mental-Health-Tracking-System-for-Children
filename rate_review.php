...
<div class="container-fluid">
    <form action="" id="rate-review">
        ...
        <div class="form-group">
            ...
            <div class="stars">
                    <input value="5" class="star star-5" id="star-5" type="radio" name="rate" checked/> <label class="star star-5" for="star-5"></label> 
                    <input value="4" class="star star-4" id="star-4" type="radio" name="rate" checked/> <label class="star star-4" for="star-4"></label> 
                    <input value="3" class="star star-3" id="star-3" type="radio" name="rate" checked/> <label class="star star-3" for="star-3"></label> 
                    <input value="2" class="star star-2" id="star-2" type="radio" name="rate" checked/> <label class="star star-2" for="star-2"></label> 
